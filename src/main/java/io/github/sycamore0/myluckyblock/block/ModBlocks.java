...
public class ModBlocks {
    ...
    static {
        MY_LUCKY_BLOCK = register("my_lucky_block", new LuckyBlock(Block.Settings.create().mapColor(MapColor.PINK).strength(0.5f).resistance(5000000.0f)));
        DEBUG_LUCKY_BLOCK = register("debug_lucky_block", new LuckyBlock(Block.Settings.create().mapColor(MapColor.GOLD).strength(0.5f).resistance(5000000.0f), "test", true, Text.translatable("block.myluckyblock.debug_lucky_block.tooltip")));
    }
