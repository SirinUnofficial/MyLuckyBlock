...
public class ModBlocks {
    ...
    static {
        ...
        DEBUG_LUCKY_BLOCK = register("debug_lucky_block", new LuckyBlock(Block.Settings.create().mapColor(MapColor.GOLD).strength(0.5f).resistance(5000000.0f), "test", true));
    }
