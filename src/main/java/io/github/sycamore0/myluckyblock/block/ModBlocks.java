...
public class ModBlocks {
    ...
    static {
        ...
        DEBUG_LUCKY_BLOCK = register("debug_lucky_block", (settings) -> new LuckyBlock(settings, MyLuckyBlock.MOD_ID, true), Block.Settings.create().mapColor(MapColor.GOLD).strength(0.5f).resistance(5000000.0f));
    }
